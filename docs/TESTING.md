...
| MCP layer (`src/main/mcp/**`), built-in servers, computer use (`mcp/cua.ts`, `CuaCard.tsx`) | `tests/mcp.test.ts`, `tests/mcp-gitnexus.test.ts`, `tests/cua.test.ts`, `tests/cua-card.test.tsx` |
